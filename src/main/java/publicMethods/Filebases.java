...
//        return new String(filecontent);//返回文件内容,默认编码
    ...
    public static void main(String[] args) {
        String file=Filebases.readfile("M:\\program\\cip\\DOCOMO\\program\\resource\\validcategory.txt");
    ...
    public static void WriteMap2File(String filepath,Map<Object,Object> map)
    {
        ...
        Write2File(stringBuffer.toString(),filepath,false);
    }
}
